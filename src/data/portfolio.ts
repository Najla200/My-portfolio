...
export const projects: Project[] = [
  ...
  },
  {
    ...
    image: `${import.meta.env.BASE_URL}images/hms.png`,
    category: 'mobile',
    technologies: ['HTML', 'CSS', 'JavaScript', 'PHP', 'MySQL'],
    liveUrl: 'https://example.com',
  ...
  },
  {
    ...
    image: `${import.meta.env.BASE_URL}images/tra.png`,
    category: 'ai',
  ...
  },
  {
    ...
    image: `${import.meta.env.BASE_URL}images/circularProgress.png`,
    category: 'web',
  ...
  // === NEW ARTICLES ===
  {
    ...
    image: `${import.meta.env.BASE_URL}images/article1.png`, 
    category: 'article',
  ...
  },
  {
    ...
    image: `${import.meta.env.BASE_URL}images/article2.png`, 
    category: 'article',
    technologies: ['Article'],
